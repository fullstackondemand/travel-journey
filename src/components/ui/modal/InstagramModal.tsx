    ...
    return <OuterModal>
        <div className={`w-[95%] lg:w-auto fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 text-white ${open ? 'scale-x-100' : 'scale-x-0'}`}>
            <div className="flex w-full">
                ...
                <img className="aspect-square -rotate-6 z-10 object-cover min-w-[33%] lg:min-w-[35vh] min-h-[33%] lg:min-h-[35vh] max-w-[33%] lg:max-w-[35vh] max-h-[33%] lg:max-h-[35vh] rounded-2xl" src="https://res.cloudinary.com/dusb7aq4h/image/upload/c_limit,w_500/f_auto/q_auto/v1/meet_marnix_2_gapz8w?_a=BBDAAEAD0" />
                <img className="aspect-square rotate-12 z-50 object-cover min-w-[33%] lg:min-w-[35vh] min-h-[33%] lg:min-h-[35vh] max-w-[33%] lg:max-w-[35vh] max-h-[33%] lg:max-h-[35vh] rounded-2xl" src="https://res.cloudinary.com/dusb7aq4h/image/upload/c_limit,w_500/f_auto/q_auto/v1/meet_marnix_3_jge6ul?_a=BBDAAEAD0" />
            </div>
            ...
            <div className="justify-center flex w-full mt-9">
                <div className="bg-[#F5F5F5] rounded-xl px-10 py-6 text-center flex flex-col items-center text-black">
                    ...
                    <a href="#" target="_blank" className="flex items-center mt-4 text-white py-2 px-4 rounded-xl gap-2 bg-black">
                        <SiInstagram /> follow
                    </a>
                </div>
            </div>
