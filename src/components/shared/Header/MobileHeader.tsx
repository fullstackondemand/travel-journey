...
export default function MobileHeader() {
    ...
    return <nav className={`lg:hidden relative ease-initial duration-300 ${open ? 'h-[200px]' : 'h-auto'}`}>
        ...
        <div className="absolute z-50 bg-white flex items-center flex-col gap-3 top-12 font-medium left-0 w-full">
            ...
            <a href="#" className="py-2 px-4 rounded-lg duration-150 flex gap-1 items-center bg-black text-white">get started <HiOutlineArrowRight /></a>
        </div>
    </nav >
}